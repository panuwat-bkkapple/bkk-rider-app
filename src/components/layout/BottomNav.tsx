...
export const BottomNav = ({ activeTab, onTabChange }: BottomNavProps) => (
  <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-3 flex justify-around items-center z-50 pb-safe shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
    {tabs.map(tab => (
      <button
        key={tab.id}
