...
//
// ที่มา (บั๊กจากเครื่อง Android ของไรเดอร์จริง 4 ก.ย. 2569): index.html ประกาศ
...
// Samsung Internet ที่ใช้เอนจินเดียวกัน). แอปนี้เป็นไทยล้วนสำหรับไรเดอร์ไทย
// ไม่มีเคสที่ต้องการให้แปล — ถ้าวันหนึ่งมีไรเดอร์ต่างชาติ ให้ทำ i18n ในแอปเอง
